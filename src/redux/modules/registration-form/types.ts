...
export enum Actions {
  ...
  GET_BY_COURSE_ID_REGISTRATION_FORM_FETCHING = 'GET_BY_COURSE_ID_REGISTRATION_FORM_FETCHING',
  GET_BY_COURSE_ID_REGISTRATION_FORM_SUCCESS = 'GET_BY_COURSE_ID_REGISTRATION_FORM_SUCCESS',
  GET_BY_COURSE_ID_REGISTRATION_FORM_ERROR = 'GET_BY_COURSE_ID_REGISTRATION_FORM_ERROR',
}
